...
public class CombinedSpriteFactory {
	...
	public static List<CombinedSprite> generateCombinedSprites(List<Sprite> sprites) throws SpriteBuilderException{
		
		if (sprites.size()==0) return new ArrayList<CombinedSprite>();
